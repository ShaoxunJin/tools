...
if not exist Dem_*.c goto DONE_DME_FILE_NOT_EXIST
if not exist Dem_*.h goto DONE_DME_FILE_NOT_EXIST

xcopy /y Dem_*.c %right_folder_string%
xcopy /y Dem_*.h %right_folder_string%

set left_folder=..\..\..\..\DevelopmentView\Application\Qm\DiagSrvs\Dem\Cfg
